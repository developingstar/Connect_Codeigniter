angular.module('6connect').controller('allservicesCtrl', allservicesCtrl)
...
function allservicesCtrl($scope, $http, $rootScope, notify) {
     $scope.services = {};
     $scope.searchname = {};
     ...
     $scope.getservices = function (page) {
          ...
          $http
                  .post(BASE_URL + 'app/mainadmin/serviceslist_json',
                          $scope.serviceslistdata)
                  .success(
                          function (data) {
...
function newownservicesCtrl($scope, $http, notify, $state) {
     ...
     $http.post(BASE_URL + 'courier_management/allcourier_json'
             ).success(function (data) {
          if (data.couriers) {
...
function editownservicesCtrl($scope, $http, notify, $state, $stateParams, $scope, orderService) {
     ...
     $http.post(BASE_URL + 'couriers/ownservices/get_service/'
