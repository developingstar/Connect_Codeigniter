                    ...
                    <div class="col-md-12">
                         ...
                         <div class="hpanel">
                              <div class="panel-body lite-shadow">
                                   ...
                                   <?php
                                     $continue= $this->input->get('continue') ? '/?continue=' . urlencode($this->input->get('continue')) : '';

                                     echo form_open(site_url('partner_account/sign_in'.$continue) , 'class=""'); ?>
                                   ...
                                   <div class="checkbox col-lg-6" style="margin-top: 0px !important">
