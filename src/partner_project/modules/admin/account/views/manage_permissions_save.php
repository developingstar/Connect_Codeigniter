    ...
    <div class="span10">
      ...
      <div class="control-group <?php echo (form_error('permission_key') || isset($permission_key_error)) ? 'error' : ''; ?>">
          ...
          <div class="controls">
            ...
            <?php else : ?>
              <?php echo form_input(array('ng-model' => 'permission_key', 'id' => 'permission_key', 'value' => set_value('permission_key') ? set_value('permission_key') : (isset($permission->key) ? $permission->key : ''), 'maxlength' => 80)); ?>
      ...
      <div class="control-group <?php echo form_error('permission_description') ? 'error' : ''; ?>">
          ...
          <div class="controls">
               <textarea ng-model="permission_description" id="permission_description" rows="4" ng-init="permission_description='<?=$permission->description?>'"></textarea>
