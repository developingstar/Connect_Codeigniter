                              ...
                              <div class="panel-body" style="border:none !important;"> 
                                   <form name="changePasswordForm" class="form-horizontal" ng-submit="changePasswordForm.$valid && save()">
                                        ...
                                        <div class="form-group">
                                             <label class="col-sm-4 control-label" for="password_new_password"><?php echo lang('password_new_password'); ?></label>

                                             <div class="col-sm-8">
                                                  <?php echo form_password(array('ng-model' => 'password_new_password', 'id' => 'password_new_password', 'class' => 'form-control', 'autocomplete' => 'off')); ?>
                                                  <span class="help-inline" ng-class="{'text-danger':errors.new_password_pattern_error}"><?=  lang('password_pattern')?></span>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-8">
                                                  <?php echo form_password(array('ng-model' => 'password_retype_new_password', 'class' => 'form-control', 'id' => 'password_retype_new_password', 'value' => set_value('password_retype_new_password'), 'autocomplete' => 'off')); ?>
