                                        ...
                                        <div class="col-md-12 no-padding">
                                             <div ng-hide="isEditing">
                                                  <div class="col-md-2 col-sm-3 text-left col-xs-5">
                                                       <div class="avatar">
                                                            <?php
                                                              if ($organisation->avatar == "" || !is_file('../filebox/organisation/' . $organisation->avatar)) {
                                                                   $src = "resource/images/default_org.jpg";
                                                              } else {
                                                                   $src = 'filebox/organisation/' . $organisation->avatar;
                                                              }
                                                            ?>
                                                            <img id="org_profile_dp" src="<?= outer_base_url($src) ?>" alt="avatar" class="img-circle m-b" ng-hide="isEditing">
                                                                        ...
                                                                        <fieldset>
                                                                             ...
                                                                             <div class="form-group">
                                                                                  ...
                                                                                  <div class="col-md-12 col-lg-7">
                                                                                       ...
                                                                                       <span class="help-block m-b-none" ng-show="errors.website_error">{{errors.website_error}}</span>
