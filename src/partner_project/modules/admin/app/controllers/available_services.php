<?php
  ...
  class Available_services extends MY_Controller {
       ...
       function __construct() {
            parent::__construct();
            $this->load->model(array('services_model', 'request_courier_service_model',
                'couriers/courier_service_model', 'couriers/surcharge_items_model', 'app/members_model'));
       }
       ...
       public function available_service_list() {
            ...
            $total_result = $this->services_model->service_count($search, $type);
            ...
            $result['page'] = $page;
            $services = $this->services_model->services($perpage, $search, $start, $org_id, $type);
            $days = array('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday');
