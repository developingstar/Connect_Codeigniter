       ...
       public function invite() {
            ...
            if (isset($send_mail)) {
                 ...
                 $message = array(
                     ...
                     'link_title' => "",
                     'link' => "",
                     'link2' => "You are invited to be a pre-approved courier by organisation - " . $org->name);
                 ...
                 if (isset($infom_admin)) {
                      ...
                      foreach ($root_admins as $root) {
                           ...
                           $message = array(
                               ...
                               'link_title' => "",
                               'link' => "",
                               'link2' => "Courier " . $courier->company_name . "(" . $courier->email . ") has been invited by " . $org->name . " to be a pre-approved courier");
                           save_mail($to, $to_name, $subject, $message,2);
                      }
                 }
            }
