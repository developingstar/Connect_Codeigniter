...
//display basic layout for partner module
       ...
       public function update_partner($partner_id = 0) {
            ...
            $result = array();
            $post_data = json_decode(file_get_contents("php://input"));
            $owner = $this->session->userdata('partner_user_id');
       ...
       public function get_partner_json($partner_id) {
            ...
            $partner = $this->partner_model->get_partner($partner_id, $owner);
            if ($partner) {
                 $iframe_src = site_url('partner/' . $partner->shortname);
                 ...
                 $json = array(
                     ...
                     'p_color_path' => $partner->color_scheme ? outer_base_url('filebox/partner/color_scheme/' . $partner->color_scheme) : "",
