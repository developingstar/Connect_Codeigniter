                 ...
                 <div style="height: 31%;display: block;overflow:hidden;">
                      <?php for ($i = 1; $i < 4; $i++) { ?>
                           ...
                           <div style="width:50%;float:left;text-align: right;">
                                <img height="40px" src="<?= outer_base_url('filebox/ciqrcode/' . $order->consignment_id . '.png'); ?>" style="float:right;margin-left: 10px;">
                                <p>       <strong> <?php echo $order->public_id; ?></strong><br>
                                     <img height="24px" src="<?= outer_base_url('filebox/barcode/consignment_document_' . $order->public_id . '.png'); ?>">
                           ...
                           <div style="width:28%;float:left;margin-left: 2%;">
                                ...
                                <div class="pwd_connect">
                                     <img src="<?php echo outer_base_url(); ?>resource/images/6connect.png" height="30px;" style="float:left;">
