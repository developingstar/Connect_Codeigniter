                    ...
                    <div class="col-xs-12 no-padding">
                         ...
                         <div class="col-sm-12 custom_well">
                              ...
                              <div class="col-sm-12" ng-if="neworder.delivery_is_assign == 1">
                                   ...
                                   <ul class="srv_list">
                                        <li class="srv col-sm-12" ng-repeat="service in servicelist| orderBy:service_filter_field track by service.service_id" id="service{{service.service_id}}" ng-click="set_service(service)">
                                             <div class="col-sm-2">
