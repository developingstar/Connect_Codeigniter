                    ...
                    <div class="col-xs-12 no-padding">
                              ...
                              <div class=" req_bid_wrap service_wrap" ng-click="set_bid_request(1)" ng-class="{active:neworder.delivery_is_assign == 1}">
                                   <div class="col-sm-12 no-padding">     
                                        <div class="hammer_wrap service_wraper">
                                             <img src="<?= outer_base_url("resource/images/service_tab.png") ?>">
                                        </div>
                              ...
                              <div class="req_bid_wrap quote_wrap" ng-click="set_bid_request(2)" ng-class="{active:neworder.delivery_is_assign == 2}">
                                   <div class="col-sm-12 no-padding">     
                                        <div class="hammer_wrap quote_wraper">
                                             <img src="<?= outer_base_url("resource/images/bidding_tab.png") ?>">
                                        </div>
                         ...
                         <div class="col-sm-4 no-padding">
                              <div class="req_bid_wrap quote_wrap" ng-click="set_bid_request(3)" ng-class="{active:neworder.delivery_is_assign == 3}">
                                   <div class="col-sm-12 no-padding">     
                                        <div class="hammer_wrap quote_wraper">
                                             <img src="<?= outer_base_url("resource/images/direct_tab.png") ?>">
                                        </div>
                         ...
                         <div class="col-sm-12 custom_well">
                              ...
                              <div class="col-sm-12" ng-if="neworder.delivery_is_assign == 1">
                                   ...
                                   <ul class="srv_list">
                                        <li class="srv col-sm-12" ng-repeat="service in servicelist| orderBy:service_filter_field track by service.service_id" id="service{{service.service_id}}" ng-click="set_service(service, true)" ng-attr-title="{{(service.is_public == 0) ? 'This service is approved for use by your billing organisation.':''}}">
                                             <div class="col-xs-12 col-sm-3 col-md-2">
                                                  <p class="estimate"><?= lang('estimated_price') ?></p>
                                                  <p class="price_tag">{{service.price}} SGD</p>
                                             ...
                                             <div class="col-xs-12 col-sm-5 col-md-6">
                                                  ...
                                                  <p class="srv_terms" ng-if="service.payment_terms"><?= lang('service_payment') ?> : {{service.payment_terms}}</p>
                                             ...
                                             <div class="col-xs-12 col-sm-4 col-md-4">
                                                  <span class="pull-right tick"><img src="<?= outer_base_url('resource/images/tick.png') ?>"></span>
