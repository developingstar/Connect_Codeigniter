<?php
  ...
  $lang['order_criteria'] = "You are responsible for making sure your Parcel meets the criteria. Additional charges might incur if parcel does not meet the criteria.<br> <br>For more information, please visit our FAQs.";
  ...
  $lang['thridparty_new_job_email_subject'] = 'New Job from 6Connect';
  $lang['thridparty_new_job_email'] = "You have received a Delivery Order from %s (%s).<br />"
          . "Please click on the link below to see the order and also update the status.";
  /*
    |--------------------------------------------------------------------------
    | Organisation
    |--------------------------------------------------------------------------
  ...
  $lang['service_payment'] = "Payment Terms";
...
+To reset your password, please click on the link below or copy and paste the URL into your browser:<BR>%s";
  ...
  $lang['order_cancel_request_email_link_title']="View order";
  ...
  $lang['order_cancel_accept_email_link_title']="View order";
  ...
  $lang['comment_response_email_link_title'] = "View Order";
  ...
  $lang['cancel_order_email_title'] = "Order cancelled by user";
  $lang['cancel_order_email_content'] = "A delivery order that was assigned/awarded to you has been cancelled by member";
  ...
  $lang['change_order_email_link_title'] = "View Order";
  ...
  $lang['status_update_email_link_title'] = "View Order";
  ...
  $lang['threshold_email_link_title'] = "Open bid case";
  ...
  $lang['init_track_info'] = "Key in the tracking numbers in the textbox above to begin.";
  /*
   * ----------------------------------------------------
   * partner users
   * ----------------------------------------------------
  ...
  $lang['benefits'] = "Benefits for using Organisation";
  $lang['benefits1'] = "Track delivery usages by individuals and by departments";
  $lang['benefits2'] = "Setup pre-approved services for staffs and teams to use";
  $lang['benefits3'] = "Generate usage reports and consolidate payments to the couriers";
  $lang['benefits4'] = "Get quotations from pre-selected list of couriers";
  ...
  $lang['welcome_partner'] = 'Welcome to <b>myBusiness Courier</b>';
