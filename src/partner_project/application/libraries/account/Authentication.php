<?php
  ...
  class Authentication {
       ...
       function is_signed_in() {
            return $this->CI->session->userdata('partner_user_id') ? TRUE : FALSE;
       }
       ...
       function sign_in($user_id, $remember = FALSE) {
            ...
            $this->CI->session->set_userdata('partner_user_id', $user_id);
       ...
       function sign_out() {
            ...
            $this->CI->session->unset_userdata('partner_user_id');
       }
