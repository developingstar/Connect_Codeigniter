...
<p>This privacy policy is for this website [www.6connect.biz] and served by 6Connect Pte. Ltd. and governs the privacy of its users who choose to use it.</p>
...
<p><u><strong>The Website </strong></u></p>
<p>This website and its owners take a proactive approach to user privacy and ensure the necessary steps are taken to protect the privacy of its users throughout their visiting experience. This website complies to all Republic of Singapore Laws and requirements for user privacy.</p>

<p><u><strong>Use of Cookies</strong></u></p>
...
<p><u><strong>Contact &amp; Communication</strong></u></p>
...
<p><u><strong>Email Newsletter</strong></u></p>
...
<p>Subscriptions are taken in compliance with Singapore Spam Control Act. No personal details are passed on to third parties nor shared with companies / people outside of the company that operates this website.</p>
...
<p><u><strong>Adverts and Sponsored Links</strong></u></p>
...
<p><u><strong>Social Media Platforms</strong></u></p>
...
<p><u><strong>Shortened Links in Social Media</strong></u></p>
...
<!--                    <p>Important – please read these terms carefully. By using this Service, you agree that you have read, understood, accepted and agreed with the Terms of Use. You further agree to the representations made by yourself below. If you do not agree to or fall within the Terms of Use of the Service (as defined below) and wish to discontinue using the Service, please do not continue using this Application or Service.</p>
                    <p>The terms and conditions stated herein (collectively, the "Terms of Use" or this "Agreement")) constitute a legal agreement between you and White Unicorn Inc. (Company No. 297740) (the "Company"). In order to use the Service (each as defined below) you must agree to the Terms of Use that are set out below. By using the mobile application supplied to you by the Company (the "Application"), and downloading, installing or using any associated software supplied by the Company ("the Software") which overall purpose is to enable persons seeking transportation services to certain destinations to be matched with third party transportation providers, drivers and vehicle operators (collectively, the "Service"), you hereby expressly acknowledge and agree to be bound by the Terms of Use, and any future amendments and additions to this Terms of Use as published from time to time at http://www.grabtaxi.com or through the Application.</p>
                    <p>The Company reserves the right to modify, vary and change the Terms of Use or its policies relating to the Service at any time as it deems fit. Such modifications, variations and or changes to the Terms of Use or its policies relating to the Service shall be effective upon the posting of an updated version at http://www.grabtaxi.com. You agree that it shall be your responsibility to review the Terms of Use regularly and also the Terms of Use applicable to any country where you use the Service which may differ from the country where you registered for the Application ("the Alternate Country") whereupon the continued use of the Service after any such changes, whether or not reviewed by you, shall constitute your consent and acceptance to such changes. You further agree that usage of the Service in the Alternate Country shall be subject to the Terms of Use prevailing for the Alternate Country which can be found at http://www.grabtaxi.com. </p>
                    <p>THE COMPANY IS A TECHNOLOGY COMPANY THAT DOES NOT PROVIDE TRANSPORTATION SERVICES AND THE COMPANY IS NOT A TRANSPORTATION PROVIDER. IT IS UP TO THE THIRD PARTY TRANSPORTATION PROVIDERS TO OFFER TRANSPORTATION SERVICES TO YOU AND IT IS UP TO YOU TO ACCEPT SUCH TRANSPORTATION SERVICES. THE SERVICE OF THE COMPANY IS TO LINK YOU WITH SUCH TRANSPORTATION PROVIDERS, BUT DOES NOT NOR IS IT INTENDED TO PROVIDE TRANSPORTATION SERVICES OR ANY ACT THAT CAN BE CONSTRUED IN ANY WAY AS AN ACT OF A TRANSPORTATION PROVIDER. THE COMPANY IS NOT RESPONSIBLE NOR LIABLE FOR THE ACTS AND/OR OMISSIONS OF ANY TRANSPORTATION PROVIDER AND/OR ANY TRANSPORTATION SERVICES PROVIDED TO YOU. </p>
                    ...
                    <p>You may only access the Service using authorized means. It is your responsibility to check and ensure that you have downloaded the correct Software for your device. The Company is not liable if you do not have a compatible device or if you have downloaded the wrong version of the Software to your device. The Company reserves the right not to permit you to use the Service should you use the Application and/or the Software with an incompatible or unauthorized device or for purposes other than</p>
                    <p>which the Software and/or the Application is intended to be used.</p>
                    <p>By using the Software or the Application, you agree that:</p>
                    <p>By using the Software or the Application, you agree that:</p>
                    <p>ou will only use the Service for lawful purposes;<br>
                         You will only use the Service for the purpose for which it is intended to be used;<br>
                         You will not use the Application for sending or storing any unlawful material or for fraudulent purposes;<br>
                         You will not use the Application and/or the Software to cause nuisance, annoyance, inconvenience or make fake bookings;<br>
                         You will not use the Service, Application and/or Software for purposes other than obtaining the Service;<br>
                         You shall not contact the Third Party Transportation Provider for purposes other than the Service;<br>
                         You will not impair the proper operation of the network;<br>
                         You shall not intentionally or unintentionally cause or attempt to cause damage to the third party transportation provider;<br>
                         You will not try to harm the Service, Application and/or the Software in any way whatsoever;<br>
                         You will not copy, or distribute the Software or other content without written permission from the Company;<br>
                         You will only use the Software and/or the Application for your own use and will not resell it to a third party;<br>
                         You will keep secure and confidential your account password or any identification we provide you which allows access to the Service;<br>
                         You will provide us with whatever proof of identity we may reasonably request or require;<br>
                         You agree to provide accurate, current and complete information as required for the Service and undertake the responsibility to maintain and update your information in a timely manner to keep it accurate, current and complete at all times during the term of this Agreement. You agree that the Company may rely on your information as accurate, current and complete. You acknowledge that if your information is untrue, inaccurate, not current or incomplete in any respect, the Company has the right but not the obligation to terminate this Agreement and your use of the Service at any time with or without notice;<br>
                         You will only use an access point or data account (AP) which you are authorized to use;<br>
                         You shall not employ any means to defraud the Company or enrich yourself, through any means, whether fraudulent or otherwise, through any event, promotion or campaign launched by the Company to encourage new subscription or usage of the Service by new or existing Passengers;<br>
                         You are aware that when requesting transportation services by SMS or use of the Service, standard telecommunication charges will apply;<br>
                         You shall not impair or circumvent the proper operation of the network which the Service operates on;<br>
                         You agree that the Service is provided on a reasonable effort basis;<br>
                         You agree that your use of the Service will be subject to the Company's Privacy Policy as may be amended from time to time; and<br>
                         Where you use the Service in Malaysia, you confirm and represent that you fall within the</p>-->
               </div>
          </div>
     </div>
</section>
