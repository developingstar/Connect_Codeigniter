...
<html xmlns:ng="http://angularjs.org" data-ng-app="6connect" id="ng-app">
     <head>
          ...
          <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>resource/bower_components/daterangepicker/daterangepicker-bs3.css" />
          <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>resource/styles/bootstrap-datetimepicker.css" />
          ...
          <link rel="stylesheet" href="<?php echo base_url(); ?>resource/bower_components/angular-bootstrap-lightbox/dist/angular-bootstrap-lightbox.css">
     ...
     <body ng-controller="appCtrl" class="{{$state.current.data.specialClass}}" landing-scrollspy tour backdrop="true">
          ...
          <div id="wrapper">
                    ...
                    <div class="angular_popup_overlay_trans" ng-show="show_popup">
                         <div class="angular_popup courier_popup pull-right popup">  
                              <h2>Courier Profile<span class="pull-right" ng-click="cancel_popup()">
                                        <img src="<?= base_url() . 'resource/styles/img/close_gray.png' ?>"></span>
                              </h2>
                              <div class="form-holder">
                                   <div class="courier-box"> 
                                        <div class="col-xs-12 col-sm-4" style="padding-left: 0px;">
                                             ...
                                             <div class="col-xs-12">
                                                  <p></p>
                                                  <b class="d3color">Office Address</b>
                                                  <p class="courier_addr" style="white-space: pre-wrap;">{{u_courier.reg_address}}</p>
                                             </div>

                                             <div class="col-xs-12" ng-if="(u_courier.reg_no)">
                                                  <p></p>
                                                  <b class="d3color">Business Reg. No</b>
                                                  <p class="courier_addr">{{u_courier.reg_no}}</p>
                                             </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-8 no-padding">
                                             <p class="courier_title">{{u_courier.name}}<br>
                                             ...
                                             <div class="row">
                                                  <div class="col-lg-4 col-md-4 reponsive">
                                                       <div class="border add_new_org" style="min-height: 50px;margin: 0">
                                                            <span>Success Rate</span>
                                                            <p style="font-size: 29px;text-align: center;">{{u_courier.success_rate}}</p>
                                                       </div>
                                                  </div>
                                                  <div class="col-lg-4 col-md-4 reponsive">
                                                       <div class="border add_new_org" style="min-height: 50px;margin: 0">
                                                            <span>Deliver On time</span>
                                                            <p style="font-size: 29px;text-align: center;">{{u_courier.del_time_rate}}</p>
                                                       </div>
                                                  </div>
                                                  <div class="col-lg-4 col-md-4 reponsive">
                                                       <div class="border add_new_org" style="min-height: 50px;margin: 0">
                                                            <span>Job Accept</span>
                                                            <p style="font-size: 29px;text-align: center;">{{u_courier.accept_rate}}</p>
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-xs-12 no-padding">
                                                  <p></p><b class="d3color">Insurance policy</b>
                                                  <p class="courier_addr">{{u_courier.insured_policy}}</p>
                                             </div>
                                        </div>
               ...
               <div data-ui-view  style="min-height:350px;"></div>
          ...
          <script src="<?php echo base_url(); ?>resource/bower_components/slimScroll/jquery.slimscroll.min.js"></script>
          ...
          <script src="<?php echo base_url(); ?>resource/scripts/config.js"></script>
          ...
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/phonebookService.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/main.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/appControllers.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/accnotification.js"></script> 
          ...
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/dashboard.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/members.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/organisation.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/activities.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/groups.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/services.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/orderservice.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/delivery_order.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/multiorder.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/userreports.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/overallreports.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/groupreports.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/partner.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/courier_management.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/mycontacts.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/service_request.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/available_services.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/pre_approved_bidders.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/tip_of_the_day.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/org_tracking.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/partner_user.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/paymentCtrl.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/feedbackController.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/accounts.js"></script>
          <script src="<?php echo base_url(); ?>resource/scripts/controllers/ownservices.js"></script>
          <!-- endbuild -->
