...
?>
               ...
               var apis = {
                    ...
                    'trackorders': [
                         'company/trackorders',
                         '{"org_id":"","tracking_ids":""}',
                         'Track orders API is used for allowing non-member to track delivery status. This API requires two parameters.' +
                                 '<h5>Parameter</h5>' +
                                 '<strong>org_id</strong> : Organisation ID (mandatory)<br>' +
                                 '<strong>tracking_ids</strong> : Tracking ID. You can track more than one item at a time by typing IDs separated by a comma or a space. Up to 25 item per request (mandatory).<br>'
                    ]
               };
