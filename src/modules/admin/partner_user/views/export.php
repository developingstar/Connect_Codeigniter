<div id="userperform">
     <div class="panel panel-default">
          <div class="panel-heading">
               <h3><?= lang('export_csv_title') ?></h3>
          </div>
          <div class="panel-body">

               <div class="col-lg-12 no-padding">
                    <div class="col-lg-12 no-padding">                        
                         <form action="<?= site_url('partner_user/get_orders_csv') ?>" method="post" class="inline_form">
                              ...
                              <div class="col-xs-12 col-sm-4 m-b-md">
                                   <button type="submit" class="btn btn-primary"><?= lang('export_csv') ?></button>
                              </div>
                         </form>            
                    </div>
                    <script>
