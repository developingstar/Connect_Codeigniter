                         ...
                         <div class="item_details cfm_box">
                              ...
                              <div>
                                   <table class="review_table">
                                        ...
                                        <tr ng-if="neworder.delivery_is_assign == 1">
                                             ...
                                             <td class="details">
                                                  <div class="input-group input-group-sm input-c">
                                                       ...
                                                       <input min="0" max="{{neworder.assigned_service.price}}" type="number" class="form-control" ng-model="neworder.threshold" ng-disabled="neworder.assigned_service.is_public == 0" ng-class="{error:errors.threshold}">
                                                  </div>
                                        ...
                                        <tr ng-if="neworder.delivery_is_assign == 1">
                                             <td><?= lang('payment_mode') ?></td>
                                             <td class="colon">:&emsp;</td>
                                             <td>
                                                  <select class="form-control" ng-model="neworder.payment_mode">
                                                       <option value="{{payment.value}}" ng-repeat="payment in payment_modes">{{payment.name}}</option>
