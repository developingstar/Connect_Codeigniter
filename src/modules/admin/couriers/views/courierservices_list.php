<div id="rightView" ng-hide="$state.current.name === 'ownservices'">
     <div ui-view></div>
</div>
<div class="content" ng-show="$state.current.name === 'ownservices'">
     <div  animate-panel>
          <div class="row">
               <div class="col-lg-12">
                                   ...
                                   <div class="col-md-12 no-padding margin_bottom_10 search_toolbar">
                                        ...
                                        <div class="pull-right no-padding">  
                                             ...
                                             <div class="no-padding table_filter" style="display: inline-flex;">
                                                  ...
                                                  <a ui-sref="ownservices.newservice" class="btn btn-sm btn-info"><?= lang('new_service') ?></a>
                                             </div>
                                        </div>
                                   </div>
                                   <div class="clr"></div>
                                        ...
                                        <table id="services_list"   class="table table-striped table-bordered table-hover ">
                                             ...
                                             <tbody>
                                                  <tr ng-repeat="service in serviceslist| orderBy:orderByField:reverseSort">
                                                       <td>
                                                            <a ng-if="!(service.is_new == 1 && service.is_archived == 0)" ui-sref="ownservices.view_service({os_id:service.id})" class="link_color"> 
                                                                 {{service.service}}
                                                            </a>
                                                            
                                                            <a ng-if="service.is_new == 1 && service.is_archived == 0" ui-sref="ownservices.edit_service({os_id:service.id})" class="link_color"> 
                                                                 {{service.service}}
                                                            </a>
