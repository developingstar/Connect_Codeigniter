     ...
     <tr style="background-color:#f3f3f3;">
          <td>
               <table style="width: 100%;">
                    <tr><td colspan="2" style="color: #999;font-size: 18px;padding: 15px;padding-left: 25px;">We hope you have a good and smooth delivery with our couriers</td></tr>
     ...
     <tr>
          <td colspan="2">
               ...
               <table style="width: 100%">
                    <tr>
                         <td style="width: 50%">
                              <h2 style="font-size: 23px;text-decoration: underline;margin-top: 0">RECEIPT DETAIL</h2>
                         ...
                         <td style="width: 50%;">
                              <div style="background-color:#f3f3f3;padding: 15px;margin-top: 10px;">
                                   <h3 style="color: #FFBC0A">Booking Summery</h3>
