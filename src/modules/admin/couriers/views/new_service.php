                              ...
                              <div class="panel-body">
                                   <div class="form-holder">
                                        <form class="form-horizontal" name="new_service_form" ng-submit="new_service_form.$valid && save()" id="new_c_service_form">
                                             <h3 class="order_title"><?= lang('add_new_service') ?></h3>
                                             <fieldset>
                                                  ...
                                                  <!--                                                                 <div class="form-group">
                                                                                                                        <div class="col-sm-12">
                                                                                                                             <label class="control-label">Organisation <small>(Leave empty if its for tenders )</small></label>
                                                                                                                             <select ng-model="new_service.org" class="form-control required col-sm-6" ng-options="org.org_id as org.org_name for org in orglist" ng-class="{error:errors.org}">
                                                                                                                                  <option value="">Select Organisation</option>                                                                            
                                                                                                                             </select>
                                                                                                                             <span class="help-block m-b-none text-danger">{{errors.service_id}}</span>
                                                                                                                        </div>
                                                                                                                   </div>-->
                                                  <div class="form-group">
                                                       <div class="col-sm-6">
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-sm-6">                                                              
                                                            ...
                                                            <select ng-model="new_service.deliverytime" class="form-control"  ng-change="setCRange()" ng-options="sc as sc.name for sc in csclist">
