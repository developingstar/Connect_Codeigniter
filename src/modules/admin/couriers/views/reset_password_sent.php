     ...
     <body class="blank" ng-app="appController">
                    ...
                    <div class="col-md-12">
                         ...
                         <div class="hpanel">
                              <div class="panel-body">
                                   ...
                                   <?php echo sprintf(lang('reset_password_sent_instructions'), anchor('couriers/forgot_password', lang('reset_password_resend_the_instructions'))); ?>
                                   <p class="text-center go-back-link"><?php echo anchor('couriers/login', lang('go_back_login')); ?></p>
          ...
          <script>
               $(document).ready(function () {
                    setTimeout(function () {
                         window.location.href = '<?= site_url('couriers/login') ?>';
                    }, 60000);
               });
          </script>
