                         ...
                         <div class="col-sm-6 no-padding">
                              <div class="a-box a-box-left">
                                   <div class="col-sm-12 address_box">
                                        ...
                                        <div class="col-sm-12 no-padding">
                                             <div class="form-group">
                                                  <div class="form-control"><?= $order->collection_contact_email ? $order->collection_contact_email : '<span class="text-muted">' . lang('no_email') . '</span>' ?></div>
                                             </div>
                                        </div>                                       
                                        <div class="col-sm-12 no-padding">
                                             <div class="form-group">
                                                  <div class="form-control"><?= $order->collection_company_name ? $order->collection_company_name : '<span class="text-muted">' . lang('no_company') . '</span>' ?></div>
                                             </div>
                                        </div> 
                                   </div>
                              </div>
                         ...
                         <div class="col-sm-6 no-padding">
                              <div class="a-box a-box-right">
                                   <div class="col-sm-12 address_box">
                                        ...
                                        <div class="col-sm-12 no-padding">
                                             <div class="form-group">
                                                  <div class="form-control"><?= $order->delivery_contact_email ? $order->delivery_contact_email : '<span class="text-muted">' . lang('no_email') . '</span>' ?></div>
                                             </div>
                                        </div> 
                                        <div class="col-sm-12 no-padding">
                                             <div class="form-group">
                                                  <div class="form-control"><?= $order->delivery_company_name ? $order->delivery_company_name : '<span class="text-muted">' . lang('no_company') . '</span>' ?></div>
                                             </div>
                                        </div> 
                                   </div>
                              </div>
               ...
               <?php if ($order->service != NULL) { ?>
                      <div class="col-sm-12 no-padding margin_bottom_10">
                           <div class="well a-box">
                                <div class="form-group">
                                     <p class="srv_name"><span><?= $order->service ?></span></p>
                                     <p class="srv_name"><span><?= $order->price ? 'SGD' . $order->price : '' ?></span></p>
                                </div>
