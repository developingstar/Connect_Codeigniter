                    ...
                    <div class="a-box a-box-left">
                         ...
                         <div class="col-sm-12 address_box">
                              ...
                              <div class="col-sm-8 no-padding chk">
                                   ...
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="crestricted" value="3"  type="radio" icheck> 
                                        </span> 
                                        <p>Sentosa</p>  
                                   </div> 
                    ...
                    <div class="a-box a-box-right">
                         ...
                         <div class="col-sm-12 address_box">
                              ...
                              <div class="col-sm-8 no-padding chk">
                                   ...
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.loc" name="restricted" value="3"  type="radio" icheck> 
                                        </span> 
                                        <p>Sentosa</p>  
                                   </div> 
                                   <div class="col-xs-7 no-padding">  
                              ...
                              <div class="clearfix"></div>
                              <div class="row" style="background-color: #cfcfcf;padding: 10px 0px;">
                                   <div class="col-sm-12">
                                        <div class="form-group">
                                             <div class="clearfix chk">
                                                  <span class="chk_wrap">  
                                                       <input ng-model="neworder.is_d_restricted_area.collect_back" name="collect_back" value="16"  type="checkbox" icheck> 
                                                  </span> 
                                                  <p><?= lang('collect_back') ?></p>  
                                             </div>
                                        </div>
                                   </div>
                              </div>
