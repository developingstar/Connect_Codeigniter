                         ...
                         <div class="m-t-md" ng-if="neworder.delivery_is_assign == 1">
                              ...
                              <div>
                                   <div class="input-group input-group-sm input-c">
                                        ...
                                        <input min="0" type="number" class="form-control" ng-model="neworder.threshold" ng-disabled="neworder.assigned_service.is_public == 0" ng-class="{error:errors.threshold}">
                                   </div>
