...
<div class="table-responsive">
     <table id="log_list" class="table table-striped table-bordered table-responsive">
          <thead>             
               <tr>
                    <th><?=  lang('order_log_timestamp')?>
                    <i ng-class="{'glyphicon glyphicon-sort':reverseSort_log == undefined, 'glyphicon glyphicon-sort-by-attributes-alt': reverseSort_log == true, 'glyphicon glyphicon-sort-by-attributes': reverseSort_log == false}" class="pull-right" ng-click="sortActivity()">
                    </th>
                    <th><?=  lang('order_log_details')?>
                    </th>
               </tr>
          </thead>
          <tbody>
               <tr ng-repeat="log in loglist| orderBy:orderByField_log:reverseSort_log">                   
                    <td>{{log.time|date:'dd MMM yyyy hh:mm a'}}
                    </td>
                    <td>{{log.activity}} - <?php echo $order->remarks ?></td>
               </tr>
               <tr class="no-data">
