                                        ...
                                        <div class="panel-body">
                                             ...
                                             <div class="row service_detail">
                                                  <div class="col-lg-6 border-right">
                                                       ...
                                                       <strong><?= lang('parcel_type_title') ?></strong>
                                                       <p>
                                                       		<ul>
	                                                       		<li ng-repeat="parceltype in parcelTypePrices">
	                                                       			{{ parceltype.display_name }} - <span ng-show="parceltype.type != '0'">${{ parceltype.price || 'empty' }}</span>
