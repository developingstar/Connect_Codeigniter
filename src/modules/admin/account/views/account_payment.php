<div class="panel-body" ng-controller="accountPaymentCtrl"> 
     ...
     <!--                                        <select  ng-model="account.country_code" class="form-control " placeholder="<?= lang('account_country') ?>" ng-options="country.code as country.country for country in countrylist" required>
