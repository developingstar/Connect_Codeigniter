<?php
  ...
  /**
   * Description of courier_service_model
   *
   * @author nice
   */
...
//                            ->where("courier_id", $courier_id)
       ...
       function getallserviceslist($search) {
...
//            $this->db->where('courier_service.courier_id', $courier_id);
       ...
       function get_allserviceslist($perpage, $search, $start) {
...
//            $this->db->where('CS.courier_id', $courier_id);
       ...
       function getallserviceslist_count($search,$category=NULL) {
            if ($category != NULL) {
                 switch ($category) {
                      //active
...
//            $this->db->where('CS.courier_id', $courier_id);
       ...
       function getallserviceslist_by_courier($perpage, $search, $start, $category = NULL) {
            if ($category != NULL) {
                 switch ($category) {
                      //active
                      case 1:$this->db->where('CS.status', 1);
