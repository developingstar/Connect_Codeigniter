                                   ...
                                   <div class="pull-right no-padding">                                        
                                        ...
                                        <div class="table_filter"  style="display: inline-flex;">
                                             <select class="form-control input-sm" name="perpage" ng-model="servicelistdata.type" ng-change="findservice()">
                                                  ...
                                                  <option value="pre">Pre-approved Services</option>
                                                  <option ng-repeat="ordertype in typelist | filter: {display_name: $select.search}" value="{{ordertype.consignment_type_id}}">Type: {{ordertype.display_name}}</option>
                                             </select>
                                        </div>
                                   </div>
                                        ...
                                        <tbody>
                                             <tr ng-repeat="service in servicelist">
                                                  ...
                                                  <td>
                                                       ...
                                                       <span class="btn btn-sm btn-default m-b-xs" ng-click="show_use_this_popup(service.id, service.courier_id, service.org_id)">Use Service</span>
                                                       <?php
                                                         if($root){
                                                              ?>
                                                       <a ui-sref="available_services.edit_service({as_id:service.id})" class="btn btn-sm btn-default m-b-xs">Edit</a>
                                                                   <?php
                                                         }
?>
                                                  </td>
