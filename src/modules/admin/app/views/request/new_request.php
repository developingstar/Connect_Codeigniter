                                             ...
                                             <fieldset style="padding:5px 15px;">
                                                  <div class="form-group">
                                                       <div class="col-xs-12 col-sm-8 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" ng-model="req.title" ng-class="{error:errors.title_error}" placeholder="<?= lang('srequest_title_ph') ?>" required> 
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12 col-sm-8 col-md-6">
                                                            ...
                                                            <select class="form-control" ng-model="req.org_id" ng-options="org.org_id as org.org_name for org in adminorglist" ng-change="change_bidding()" ng-class="{error:errors.org_error}" required>
                                                                 <option value="">Select Organisation</option>
                                                            </select>
                                                            <span class="help-block m-b-none text-danger" ng-show="errors.org_error">{{errors.org_error}}</span>
                                                            <div class="open_bid_wrap open"  ng-if="org_info.open_bid"  style="display: inline-flex">
                                                                 <span style="margin:auto 15px auto 0;"> 
                                                                      <input type="checkbox" ng-model="req.open_bid" ng-class="{error:errors.open_bid_error}" icheck> 
                                                                 </span>
                                                                 <div>
                                                                      <p> <?= lang('open_tender_info_service') ?></p>
                                                                 </div>
                                                            </div> 
                                                            <div class="open_bid_wrap closed"  ng-if="!org_info.open_bid">
                                                                 <div ng-show="org_info.c_count > 0">
                                                                      <h4 class="tender-title"><?= lang('closed_tender') ?></h4>
                                                                      <p> <?= lang('closed_tender_info_service') ?></p>
                                                                 </div>
                                                                 <div ng-show="org_info.c_count == 0">
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12 col-sm-12 col-md-10">
                                                            ...
                                                            <textarea class="form-control" ng-model="req.description" rows="5" placeholder="<?= lang('srequest_description_ph') ?>" ng-class="{error:errors.description_error}"></textarea>
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12">   
                                                            ...
                                                            <div class=" col-xs-6 no-padding">
                                                                 <input type="text" class="form-control" ng-model="req.duration" placeholder="<?= lang('srequest_duration_ph') ?>" ng-class="{error:errors.duration_error}" required>
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12">   
                                                            ...
                                                            <div class=" col-xs-6 no-padding">
                                                                 <input type="text" class="form-control" ng-model="req.delpermonth" placeholder="<?= lang('srequest_delpermonth_ph') ?>" ng-class="{error:errors.delpermonth_error}" required> 
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12">   
                                                            <div class=" col-xs-12 col-sm-10 no-padding">
                                                                 ...
                                                                 <input type="text" class="form-control" ng-model="req.payment" placeholder="<?= lang('srequest_payment_ph') ?>" ng-class="{error:errors.payment_error}" required> 
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12">   
                                                            <div class=" col-xs-12 col-sm-10 no-padding">
                                                                 ...
                                                                 <input type="text" class="form-control" ng-model="req.compensation" placeholder="<?= lang('srequest_compensation_ph') ?>"  ng-class="{error:errors.compensation_error}"> 
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12">   
                                                            <div class="col-xs-12 col-sm-6 no-padding bdtpicker">
                                                                 ...
                                                                 <input type="text" class="form-control" ng-model="req.expiry" id="tender_expiry" ng-class="{error:errors.expiry_error}"> 
                                                  ...
                                                  <div class="form-group">
                                                       <div class="col-xs-12">   
                                                            <div class="col-xs-12 col-md-10 no-padding tender_uploads">
