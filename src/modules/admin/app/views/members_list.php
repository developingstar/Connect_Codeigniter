                                                         ...
                                                         <fieldset>
                                                              ...
                                                              <div class="form-group col-sm-6">
                                                                   <div class="col-sm-12">
                                                                        ...
                                                                        <select class="form-control" ng-model="editmember.group_id">
                                                                             <option value="0">Select Group</option>
                                                                             <option ng-selected="{{s.group_id == editmember.group_id}}" ng-repeat="s in grouplist" value="{{s.group_id}}">{{s.group_name}}</option>
                                                                        </select>
                                                                        <span class="help-block m-b-none" ng-show="errors.name_error">{{errors.name_error}}</span>
                                                                   </div>
                                                              </div>
