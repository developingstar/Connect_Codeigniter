                                   ...
                                   <ul class="srv_list">
                                        <li class="srv col-sm-12" ng-repeat="service in servicelist| orderBy:service_filter_field track by $index" id="service{{service.service_id}}" ng-click="set_service(service, true)" ng-attr-title="{{(service.is_public == 0) ? 'This service is approved for use by your billing organisation.':''}}">
                                             ...
                                             <div class="col-xs-12 col-sm-4 col-md-3">
                                                  ...
                                                  <div style="padding-top: 10px;" ng-show="service.insured_policy!=null">
                                                       <p>Courier Insurance Policy</p>
                                                       <span style="color: #999">{{service.insured_policy}}</span>
                                                  </div>
                                    ...
                                    <div class="col-sm-12 no-service-fount-content" ng-show="servicelist.length == 0">
                                        <div class="col-sm-3 text-right">
                                             <img src="<?= base_url('resource/images/icons/no_matching.png') ?>" class="no-matching-icon">
                                        </div>
                                        <div class="col-sm-8">
                                             <h1 class="margin_bottom_0 margin_top-5"><?= lang('no_matching_service_head') ?></h1>
                                             <p class="tip-color-service no-servicecontentp"><?= lang('no_matching_service_desc') ?></p>
                                        </div>
                                   </div>
                              </div>
