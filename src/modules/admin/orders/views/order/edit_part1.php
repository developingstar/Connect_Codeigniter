<form id="editpart1" name="new_order_p1" class="form-horizontal" ng-submit="show_part_two()">
     ...
     <fieldset>
          ...
          <div class="col-sm-6 no-padding">
               ...
               <div class="col-sm-12 no-padding" style="padding: 2px 0px!important">
                    <input id="orderrefs" class="form-control" ng-class="{error:errors.ref}" ng-model="neworder.ref"  value="<?= isset($ref) ? $ref : "" ?>">
               </div>
               <div class="col-sm-12 no-padding" style="padding: 2px 0px!important">
                    <input name="tags" id="ordertags" ng-model="neworder.tags" value="<?= isset($tags) ? $tags : "" ?>" class="form-control">
               </div>
          </div>
          <div class="col-sm-3 no-padding">
               <div class="criteria">
                         ...
                         <div class="col-sm-12 address_box">
                              ...
                              <div class="col-sm-8 no-padding chk">
                                   ...
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="restricted" value="8" type="radio" icheck> 
                                        </span> 
                                        <p>Tuas <i class="fa fa-info-circle pointer" ng-click="view_tuas_info()"></i></p>  
                                   </div> 
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="restricted" value="4"  type="radio" icheck> 
                                        </span> 
                                        <p>CBD</p>  
                                   </div> 
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="restricted" value="2"  type="radio" icheck> 
                                        </span> 
                                        <p>Sentosa</p>  
                                   </div> 
                                   <div class="col-xs-7 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="restricted" value="1"  type="radio" icheck> 
                                        </span> 
                    ...
                    <div class="a-box a-box-right">
                         ...
                         <div class="col-sm-12 address_box">
                              ...
                              <div class="col-sm-8 no-padding chk">
                                   ...
                                   <div class="col-xs-6 col-sm-4 no-padding"> 
                                        <span class="chk_wrap"> 
                                             <input ng-model="neworder.is_d_restricted_area.loc" value="8" name="restricted" type="radio" icheck>
                                        </span>
                                        <p>Tuas</p> 
                                   </div>
                                   <div class="col-xs-6 col-sm-4 no-padding"> 
                                        <span class="chk_wrap"> 
                                             <input ng-model="neworder.is_d_restricted_area.loc" value="4" name="restricted" type="radio" icheck>
                                        </span>
                                        <p>CBD</p> 
                                   </div>
                                   <div class="col-xs-6 col-sm-4 no-padding"> 
                                        <span class="chk_wrap"> 
                                             <input ng-model="neworder.is_d_restricted_area.loc" value="2" name="restricted" type="radio" icheck>
                                        </span>
                                        <p>Sentosa</p> 
                                   </div>
                                   <div class="col-xs-7 no-padding"> 
                                        <span class="chk_wrap"> 
                                             <input ng-model="neworder.is_d_restricted_area.loc" value="1" name="restricted" type="radio" icheck>
                                        </span>
                                        <p><div style="display: inline-block;">Other Restricted</div> <div style="display: inline-block;">Areas<i class="fa fa-info-circle pointer" ng-click="view_restricted_info()"></i></div></p> 
                                   </div>
                                   <div class="col-xs-5 no-padding" style="vertical-align: text-bottom;display: inline-block">  
