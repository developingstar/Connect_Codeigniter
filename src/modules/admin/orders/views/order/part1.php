<form name="new_order_p1" class="form-horizontal" ng-click="new_order_p1()" ng-submit="show_part_two()">
     <style>
          .tagit{
               margin-bottom: 4px;
          }
     ...
     <h3 class="order_title"><?= lang("new_order_title") ?>
          <span class="pull-right">
               ...
               <button type="submit" class="btn btn-primary btn-sm" ng-click="newordertypesel()">
                    <?= lang('next') ?>                                                  
               </button>         
          </span>
     </h3>
          ...
          <div class="col-sm-6 no-padding">
               <div class="col-sm-12">
                    <div class="col-sm-9 no-padding">  
                         <div class="form-group custom-select2" ng-class="{
                              ...
                              <ui-select id="newordertype" ng-model="neworder.type" theme="select2"  ng-disabled="disabled" ng-change="set_bulk()" ng-required="true" style="width:100%">
               ...
               <div class="col-sm-12">
                    <div class="form-group" style="margin-bottom: 8px">  
                         <textarea class="form-control" ng-class="{error:errors.remarks}" ng-model="neworder.remarks" rows="2"  placeholder="<?= lang('order_remark_ph') ?>"></textarea>
                         <span class="help-block m-b-none text-danger" ng-show="errors.remarks">{{errors.remarks}}</span>
                    </div>
               </div>
               <div class="col-sm-12 no-padding" style="padding: 2px 0px!important">
                    <input id="orderrefs" class="form-control" ng-class="{error:errors.ref}" ng-model="neworder.ref" ng-change="get_ref_array()">
               </div>
               <div class="col-sm-12 no-padding" style="padding: 2px 0px!important">
                    <input name="tags" id="ordertags" ng-model="neworder.tags" ng-value="{{neworder.tags}}" class="form-control" ng-change="get_tag_array()">
               </div>
          </div>
          <div class="col-sm-3 no-padding">
               <div class="criteria">
               ...
               <div class="col-sm-6 no-padding">
                    <div class="a-box a-box-left">
                         ...
                         <div class="col-sm-12 address_box">
                              ...
                              <div class="col-sm-8 no-padding chk">
                                   <div class="form-group">
                                        <select  ng-model="neworder.collect_country" class="form-control " ng-class="{error:errors.collect_country}" placeholder="<?= lang('collect_country') ?>" ng-options="country.code as country.country for country in cscountrylist" ng-change="getCTimezones(true)" required>
                                   ...
                                   <div class="clearfix"></div>
                                   <br>
                                   <div class="help-block m-b-none"><?php echo lang('restricted_area_applicable') ?></div>
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="crestricted" value="8" type="radio" icheck> 
                                        </span> 
                                        <p>Tuas <i class="fa fa-info-circle pointer" ng-click="view_tuas_info()"></i></p>  
                                   </div> 
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="crestricted" value="4"  type="radio" icheck> 
                                        </span> 
                                        <p>CBD</p>  
                                   </div> 
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="crestricted" value="2"  type="radio" icheck> 
                                        </span> 
                                        <p>Sentosa</p>  
                                   </div> 
                                   <div class="col-xs-7 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="crestricted" value="1"  type="radio" icheck> 
                                        </span> 
                                        <p><div style="display: inline-block;">Other Restricted</div> <div style="display: inline-block;">Areas<i class="fa fa-info-circle pointer" ng-click="view_restricted_info()"></i></div></p>  
                                   </div> 
                                   <div class="col-xs-5 no-padding" style="vertical-align: text-bottom;display: inline-block">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.clocation" name="crestricted"  type="radio" icheck> 
                                        </span>  
                                        <p>Not Applicable</p>
                                   </div>
                              ...
                              <div class="col-sm-12 no-padding">
                                   <div class="form-group">
                                        <div class="clearfix chk">  <span style="float: left;margin:5px;"> 
                                                  <input ng-model="selected_contact.save_collect_contact" value="true" type="checkbox" icheck>
                                             </span> 
                              ...
                              <div class="col-sm-12 no-padding">
                                   ...
                                   <div class="form-group" ng-class="{hidden:neworder.collect_country}">
                                   ...
                                   <div class="form-group" ng-class="{hidden:!neworder.collect_country}">  
                                        <div class="col-xs-12 no-padding">
                                             <select ng-model="collect_shortcuts" class="form-control"   ng-change="changecollectshortcuts();" ng-options="sc as sc.name for sc in csclist">
                                             </select>
                                             <div class="col-xs-12 no-padding" ng-show="(collect_shortcuts.from == null)">
                                                  <input type="text" placeholder="Select Date" id="datepickerSingle"  ng-model="collect_shortcut_date" class="form-control d-datepicker" ng-change="setcollect_shortcut_date()"/>
                                             </div>
                                             <div class="col-xs-12 no-padding">
                                                  <select ng-model="collect_timing" class="form-control collect_timing"  ng-change="setcollect_timing()" ng-options="sc as sc.name for sc in collectlist">
                                                  </select>
                                             </div>
                                             <div class="col-xs-12 no-padding" ng-show="(collect_timing.from.hour == null)">
                                                  <select ng-model="collect_shortcut_timing" class="form-control"  ng-change="setCRange()" ng-options="sc as sc.name for sc in collect_spl_list">
                                                  </select>
                                             </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-5 no-padding"> 
               ...
               <div class="col-sm-6 no-padding">
                    <div class="a-box a-box-right">
                         ...
                         <div class="col-sm-12 address_box">
                              ...
                              <div class="col-sm-12 no-padding">
                                   <div class="form-group">
                                        <input type="text" ng-model="neworder.delivery_address_l2" class="form-control" ng-class="{error:errors.delivery_address_l2}" placeholder="<?= lang('deliver_add_l2') ?>" ng-autocomplete="mapd.result2" details="mapd.details2" options="mapd.options2"  callback-fn="set_dpin()" required>
                              ...
                              <div class="col-sm-8 no-padding chk">
                                   ...
                                   <div class="help-block m-b-none"><?php echo lang('restricted_area_applicable') ?></div>
                                   <!--                                   <div class="form-group">
                                                                                   <select  ng-model="neworder.is_d_restricted_area.loc" class="form-control " ng-class="{error:errors.is_d_restricted_area.loc" placeholder="<?php echo lang('restricted_area_applicable') ?>" ng-options="surcharge.value as surcharge.name for surcharge in locSurcharges">
                                                                                <option value=""><?php echo lang('not_applicable'); ?></option>
                                                                           </select>
                                                                      </div>-->
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.loc" name="restricted" value="8" type="radio" icheck> 
                                        </span> 
                                        <p>Tuas <i class="fa fa-info-circle pointer" ng-click="view_tuas_info()"></i></p>  
                                   </div> 
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.loc" name="restricted" value="4"  type="radio" icheck> 
                                        </span> 
                                        <p>CBD</p>  
                                   </div> 
                                   <div class="col-xs-6 col-sm-4 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.loc" name="restricted" value="2"  type="radio" icheck> 
                                        </span> 
                                        <p>Sentosa</p>  
                                   </div> 
                                   <div class="col-xs-7 no-padding">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.loc" name="restricted" value="1"  type="radio" icheck> 
                                        </span> 
                                        <p><div style="display: inline-block;">Other Restricted</div> <div style="display: inline-block;">Areas<i class="fa fa-info-circle pointer" ng-click="view_restricted_info()"></i></div></p>  
                                   </div> 
                                   <div class="col-xs-5 no-padding" style="vertical-align: text-bottom;display: inline-block">  
                                        <span class="chk_wrap">  
                                             <input ng-model="neworder.is_d_restricted_area.loc" name="restricted"  type="radio" icheck> 
                                        </span>  
                                        <p>Not Applicable</p>
                                   </div>
                              </div> 
                                   ...
                                   <div class="form-group">
                                        <div class="clearfix chk">
                                             <span style="float: left;margin:5px;"> 
                                                  <input ng-model="selected_contact.save_delivery_contact" value="true" type="checkbox" icheck>
                                             </span> 
                                             <p><?= lang('save_contact_to_my_contact') ?></p>
                                        </div>
                                        <div class="clearfix chk">
                              ...
                              <div class="clearfix"></div>
                              <div class="row" style="background-color: #f1f1f1;padding: 10px 0px;">
                                   <div class="col-sm-12">
                                        <div class="form-group">
                                             <div class="clearfix chk">
                                                  <span class="chk_wrap">  
                                                       <input ng-model="collect_back" name="collect_back_fn" ng-change="collect_back_fn()"  type="checkbox" icheck> 
                                                  </span> 
                                                  <p style="font-size: 13px!important"><?= lang('collect_back_head') ?></p>  
                                             </div>
                                        </div>
                                        <div ng-show="collect_back">
                                             <div class="form-group" style="padding-left: 30px">
                                                  <div class="clearfix chk">
                                                       <span class="chk_wrap">  
                                                            <input ng-model="neworder.pickup" name="pickup" value="1"  type="radio" icheck> 
                                                       </span> 
                                                       <p><?= lang('pre_delivery_chk') ?></p>  
                                                  </div>
                                             </div>
                                             <div class="form-group" style="padding-left: 30px">
                                                  <div class="clearfix chk">
                                                       <span class="chk_wrap">  
                                                            <input ng-model="neworder.pickup" name="pickup" value="2"   type="radio" icheck> 
                                                       </span> 
                                                       <p><?= lang('post_delivery_chk') ?></p>  
                                                  </div>
                                             </div>
                                             <div class="form-group" style="padding-left: 30px" ng-show="(neworder.pickup)">
                                                  <div class="clearfix chk">
                                                       <div class="col-sm-12" style="padding-left: 5px;">
                                                            <select  class="form-control" ng-model="neworder.collect_back_item">
                                                                 <option value="{{list.id}}" ng-repeat="list in backup_list">{{list.name}}</option>
                                                            </select>
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="form-group" style="padding-left: 30px" ng-show="(neworder.pickup)">
                                                  <div class="clearfix chk">
                                                       <div class="col-sm-12 text-danger" style="padding-left: 5px;font-size: 10px;">
                                                            <b>Tips</b> - If the {{(neworder.pickup==1)?"pre-delivery pick-up":((neworder.pickup==2)?"collect-back":"")}} location is different from the collection or delivery address, please indicate the address and contact details inside the remarks box
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                              ...
                              <div class="col-sm-12 no-padding">
                                   ...
                                   <div class="form-group" ng-class="{hidden:neworder.delivery_country}">
                                        <div class="col-xs-12 col-sm-5 no-padding"> 
                                             <div class="form-control required datepicker">
                                                  <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                   ...
                                   <div class="form-group" ng-class="{hidden:!neworder.delivery_country}">
                                        <div class="col-xs-12 no-padding">
                                             <select ng-model="delivery_shortcuts" class="form-control"   ng-change="changedeliveryshortcuts();" ng-options="sc as sc.name for sc in dsclist">
                                             </select>
                                             <div class="col-xs-12 no-padding" ng-show="(delivery_shortcuts.from == null)">
                                                  <input type="text" placeholder="Select Date" id="datepickerSingle2"  ng-model="delivery_shortcut_date" class="form-control d-datepicker" ng-change="changedeliveryshortcuts()"/>
                                             </div>
                                             <div class="col-xs-12 no-padding" ng-show="dellist[0] != undefined">
                                                  <select ng-model="del_timing" class="form-control del_timing"  ng-change="setDRange()" ng-options="sc as sc.name for sc in dellist">
                                                  </select>
                                             </div>
                                             <div class="col-xs-12 no-padding" ng-show="(del_timing.from == null)">
                                                  <select ng-model="del_shortcut_timing" class="form-control"  ng-change="setDRange()" ng-options="sc as sc.name for sc in collect_spl_list">
                                                  </select>
                                             </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-5 no-padding"> 
                                             <label><?= lang('from') ?></label>
                                             <input type="text" id="collectdate1" ng-model="neworder.deliver_date1" name="daterange" class="form-control o-datepicker" ng-disabled="delivery_shortcuts"  ng-change="setCTime()" placeholder="<?= lang('collect_date') ?>"  required>
                                             <span class="help-block m-b-none text-danger" ng-show="errors.deliver_date1">{{errors.deliver_date1}}</span>
                                        </div>
                                        <div class="col-sm-1 hidden-xs dseparator">_</div>
                                        <div class="col-xs-12 col-sm-5 no-padding"> 
                                             <label><?= lang('to') ?></label>
                                             <input type="text" id="collectdate2" ng-model="neworder.deliver_date2" name="daterange" class="form-control o-datepicker" ng-disabled="delivery_shortcuts" ng-change="setCTime()" placeholder="<?= lang('collect_date') ?>"  required>
