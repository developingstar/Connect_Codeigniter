            ...
            <div style="height: 31%;display: block;overflow:hidden;">
                <?php for ($i = 1; $i < 4; $i++) { ?>
                    <div style="width:50%;float:left;">
                        ...
                        <p style="font-weight:bold;"><?= $order->service ?> &nbsp; <?= isset($order->cb_name) ? '+ ' . $order->cb_name : "" ?></p>
                    ...
                    <div style="width:50%;float:left;text-align: right;">
                        <img height="40px" src="<?= base_url('filebox/ciqrcode/' . $order->public_id . '.png'); ?>" style="float:right;margin-left: 10px;">
                    ...
                    if ($i == 1) {
                        ?>
                        <div style="text-align: center;margin-top: 5px;"><span style="font-size: 17px;margin: auto">Please keep this portion and ensure that the courier has signed/stamped it.</span></div>
                        <?php
                    }
                    ?>
                    <table class="main" style="page-break-inside:avoid;margin-top: 0px;">
                        <tr>
                    ...
                    <div style="width:28%;float:left;margin-left: 2%;">
                        ...
                        <div class="pwd_connect">
                            <img src="<?php echo base_url(); ?>resource/images/main_logo.png" height="30px;" style="float:left;">
                        </div>
                    </div>
                    <?php if ($i != 3) {
                        ?>
