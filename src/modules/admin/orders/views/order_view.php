<div class="content" ng-class="{'padding_0':$state.current.name === 'organisation.orders.view_order' || $state.current.name === 'tender_requests.delivery.view_order'  }">
     <div class="wrap" animate-panel>
                                          ...
                                          <h3 class="order_title"><?= lang("delivery_request") ?>
                                               <span class="pull-right">                                             
                                                    ...
                                                    if($order_receipt!=NULL) { ?>
                                                         <a class="btn btn-success <?= $order->public_id ?>" ng-click="show_receipt()" >Receipt</a>
                                                         <?php
                                                    }
          ...
          <div class="angular_popup_overlay"  ng-show="receipt_view">
               <div class="angular_popup create_contact pull-right">  
                    <h3>Receipt<i class="fa fa-close pull-right" ng-click="cancel_view_receipt()"></i></h3>
                    <div class="form-holder" style="padding: 40px;background-color: #fff">
                         <?= $order_receipt ?>
                    </div>
               </div>
          </div>
